...
// const sendMarsTemperature = (temperature, delay) => setTimeout(() => 
//     console.log(`A temperatura de Marte é: ${temperature()} graus celsius`), delay());
...
const handlePokemonSearch = (error) => console.log(error)

getPokemonDetails(roger, handlePokemonSearch);
